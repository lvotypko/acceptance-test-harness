...
public class AnalysisCollectorPluginTest extends AbstractAnalysisTest<AnalysisCollectorAction> {
     ...
     */
    @Test @WithPlugins({"git",  "workflow-basic-steps", "workflow-multibranch","workflow-support", "workflow-job", "pipeline-stage-step", "workflow-cps", "workflow-durable-task-step", "workflow-scm-step", "workflow-cps-global-lib", "workflow-api", "scm-api"}) @WithDocker
