...
public class AnalysisCollectorPluginTest extends AbstractAnalysisTest<AnalysisCollectorAction> {
     ...
     */
    @Test @WithPlugins({"git", "workflow-job", "pipeline-stage-step", "workflow-cps", "workflow-durable-task-step", "workflow-scm-step", "workflow-cps-global-lib", "workflow-api"}) @WithDocker
